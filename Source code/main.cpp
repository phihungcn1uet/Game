			...
			while (!quit)
			{
				...
				while (SDL_PollEvent(&e) != 0)
				{
					...
					if (playgame == false && secondplay == false && pausegame==false ) {
						menu.startmenu(e, playgame, quit, secondplay,timewhenplay,font_playorexit, font_time, gRenderer, ResetGame);
					...
					// khi tam dung game
						...
						menu.pausemenu(e, playgame,pausegame, quit,  font_playorexit,font_time, gRenderer,figure);
					}
				}
				//khi lan dau vao game
				if (playgame == false && secondplay == false && pausegame == false) {
